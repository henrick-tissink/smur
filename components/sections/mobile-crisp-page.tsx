...
/*
  Faithful-fluid mobile CRISP case study — full desktop parity (June
  2026). Ported from components/mobile/crisp-page.tsx
  (MobileCrispCaseStudy) to Recipe B (container-query flow): the legacy
  ...
  content/crisp.ts has no `crispFrame.mobile`, so M_W = 393 (the legacy
  ...
  `w-full`/`h-auto` images, aspectRatio, %-insets, Reveal/eager/delay,
  and every image src/unoptimized/priority/alt are unchanged from legacy.
*/
